# -*- coding: utf-8 -*-
"""Codigo 3 acciones 3 min

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1grXFylBTlo5axxjEmOzOzlOQ_2c2appR
"""
...
def clean_price_series(series, name):
    ...
    if len(cleaned_series) < 40:
        print(f"Warning: Small sample size ({len(cleaned_series)} points). Expected ~130 for 3-min data over 1 day. Check for missing or invalid data.")
...
# Forecast next 30 minutes (10 periods for 3-min data)
forecast_steps = 10
...
plt.title('AMZN, MSFT, and GOOGLE Closing Prices with Forecasts (3-min, 1-day)')
plt.legend()
plt.show()

# Detailed forecast plot with confidence intervals and interpretation
def plot_forecast(model, series, name, steps=10):
    ...
    plt.title(f'{name} Price Forecast (3-min, 1-day)')
    plt.legend()
    plt.show()
...
print("\nAMZN Forecast Values (next 5 periods, 15 minutes):")
print(amzn_forecast[:5])
print("\nMSFT Forecast Values (next 5 periods, 15 minutes):")
print(msft_forecast[:5])
print("\nGOOGLE Forecast Values (next 5 periods, 15 minutes):")
